...
// configuration part
#define AWARDNAME "goldendeagle" // Name of award
#define PRICE 50 // Award price
#define AWARDTEAM ZP_HUMANS // Set team that can buy this award (use ZP_BOTH ZP_HUMANS ZP_ZOMBIES)
#define TRANSLATIONS "plague_goldendeagle.phrases" // Set translations file for this subplugin
// end configuration
...
public ZP_OnAwardBought( client, const String:awardbought[])
{
	if(StrEqual(awardbought, AWARDNAME))
	{
		...
		PrintToChat(client, "\x01\x03[\x04SM_Franug-ZombiePlague\x03]\x01 %t", "you bought goldendeagle");
		DarOro(client);
	}
}
